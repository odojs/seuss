...
var SeussQueueBusy, args, clip_range, cmds, command, commands, err, parse_range, seuss, usage, usage_error;
...
SeussQueueBusy = require('../src/errors').SeussQueueBusy;
...
cmds = {
  ...
  compact: function() {
    ...
    return usage_error('seuss compact requires one argument - the queue path');
  },
  '-h': function() {
